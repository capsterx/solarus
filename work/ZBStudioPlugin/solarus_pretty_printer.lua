...
local properties = {
  ...
  hero = entity("get_direction","get_walking_speed","get_solid_ground_position","get_animation","get_tunic_sprite_id","get_sword_sprite_id","get_sword_sound_id","get_shield_sprite_id","is_invincible","get_carried_object","get_state","get_custom_state"),
